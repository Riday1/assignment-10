...
const Checkout = () => {
    const { title, id, image, price } = useLoaderData();
        ...
        <div className='h-screen flex flex-col justify-center items-center '>
            ...
            <div className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 bg-gray-50 text-gray-800">
                <ul className="flex flex-col divide-y divide-gray-300">
                    <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
                        <div className="flex w-full space-x-2 sm:space-x-4">
                            <img className="flex-shrink-0 object-cover w-20 h-20 border- rounded outline-none sm:w-32 sm:h-32 bg-gray-500" src={image} alt="Polaroid camera" />
                ...
                <div className="flex justify-end space-x-4">
                    ...
                    <button type="button" className="px-6 py-2 border rounded-md bg-violet-600 text-gray-50 border-violet-600">

...
const SingleCourse = ({ course }) => {
    ...
    return (
        <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-lg dark:bg-[#111827] dark:text-gray-300 transition duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:shadow-xl bg-gray-100 hover:bg-violet-50">
            <div>

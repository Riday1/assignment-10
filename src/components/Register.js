...
const Register = () => {
    const { createUser, verifyEmail, updateUser, signInWithGoogle, signInWithGithub, setUser } = useContext(AuthContext)
                ...
                verifyEmail()
                    .then(() => {
                        Swal.fire({
                            ...
                            text: "A message has sent to your inbox please check it.",
                            icon: "warning"
                        });
                    })

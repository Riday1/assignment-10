...
const Login = () => {
    const { signIn, setUser, forgetPassword, signInWithGoogle, signInWithGithub } = useContext(AuthContext);
    ...
    const handleGithubSignIn = () => {
        signInWithGithub()
            .then(result => {
                ...
                setUser(user) // updating user with emailverified true , so it will help us to show user info in header section. 
                navigate('/')
            })
            .catch(e => console.error(e))
    }
